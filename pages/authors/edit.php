  ...
  <div class="app-shell">
    <aside class="app-sidebar">
      ...
      <nav>
        ...
        <a href="/pages/books/index.php" class=""><svg class="icon" width="16" height="16" viewBox="0 0 24 24"
        ...
        <a href="/pages/authors/index.php" class="active"><svg class="icon" width="16" height="16" viewBox="0 0 24 24"
            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M12 20h9" />
